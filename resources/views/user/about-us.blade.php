...
@section('content-user')
    ...
    <!-- Hero Section Begin -->
    <section class="hero-section set-bg" data-setbg="{{ asset('img/about-us-bg.jpg') }}">
        <div class="hero-text">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                ...
                {{-- <div class="page-nav">
                    <a href="{{ route('user.index') }}" class="left-nav"><i class="lnr lnr-arrow-left"></i> Home</a>
                    <a href="{{ route('user.index') }}" class="right-nav">Services <i class="lnr lnr-arrow-right"></i></a>
                </div> --}}
            </div>
        </div>
    </section>
    ...
    <section class="video-tour set-bg" data-setbg="{{ asset('img/video-bg.jpg') }}">
        <div class="container">
            <div class="video-text">
                ...
                <div class="video-play-btn">
                    <a href="{{ asset('img/about_us.mp4') }}" class="pop-up"><i class="fa fa-play"></i></a>
                </div>
            </div>
        </div>
    </section>
