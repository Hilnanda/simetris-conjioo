...
@section('content-user')
    ...
    <!-- Hero Slider Begin -->
    <section class="hero-section set-bg" data-setbg="{{ asset('img/detail-bg.jpg') }}">
        <div class="hero-text">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
            ...
            <div class="facilities-content">
                <div class="row">
                    <div class="col-lg-6 p-0">
                        <div class="facilities-img set-bg" data-setbg="{{ asset('img/room/deluxe.png') }}"></div>
                    </div>
                    <div class="col-lg-6 p-0">
                        <div class="facilities-text-warp">
                            <div class="facilities-text">
                                <h2>Deluxe Double/Twin</h2>
                                <span><strong>Room Size 19 m²</strong>
                                    <br>
                                    <br>

                                    This twin/double room has a balcony, tea/coffee maker and electric kettle.
                                </span><br><br>
                                <span class="mb-0">
                    ...
                    <div class="col-lg-6 p-0 order-lg-2 order-1 fade-bottom">
                        <div class="facilities-img set-bg" data-setbg="{{ asset('img/room/deluxe2.png') }}"></div>
                    </div>
