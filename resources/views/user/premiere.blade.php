...
@section('content-user')
    ...
    <!-- Hero Slider Begin -->
    <section class="hero-section set-bg" data-setbg="{{ asset('img/detail-premiere.jpg') }}">
        <div class="hero-text">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
            ...
            <div class="facilities-content">
                <div class="row">
                    <div class="col-lg-6 p-0">
                        <div class="facilities-img set-bg" data-setbg="{{ asset('img/room/premiere.png') }}"></div>
                    </div>
                    <div class="col-lg-6 p-0">
                        <div class="facilities-text-warp">
                            <div class="facilities-text">
                                <h2>Premiere</h2>
                                <span><strong>Room Size 22 m²</strong>
                                    <br>
                                    <br>

                                    This double room has a balcony, tea/coffee maker and electric kettle.
                                </span><br><br>
                                <span class="mb-0">
                    ...
                    <div class="col-lg-6 p-0 order-lg-1 order-2 fade-bottom">
                        <div class="facilities-text-warp">
                            <div class="facilities-text">
                                ...
                                <div class="row" style="margin-top: 7px;">
                                    <div class="col-md-12">
                                        &check; Upper floors accessible by elevator <hr class="hr-list">
                                        &check; Tea/Coffee maker <hr class="hr-list">
                                        &check; Air conditioning <hr class="hr-list">
                                        &check; Safe <hr class="hr-list">
                                        &check; Electric kettle <hr class="hr-list">
                                        &check; TV <hr class="hr-list">
                                        &check; Telephone <hr class="hr-list">
                                        &check; Satellite channels <hr class="hr-list">
                                        &check; Balcony <hr class="hr-list">
                    ...
                    <div class="col-lg-6 p-0 order-lg-2 order-1 fade-bottom">
                        <div class="facilities-img set-bg" data-setbg="{{ asset('img/room/premiere2.png') }}"></div>
                    </div>
